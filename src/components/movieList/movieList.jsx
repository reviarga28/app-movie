...
export default function MovieList() {
  ...
  return (
    <div className="w-full h-48 p-6 bg-gray-900 shadow-2xl shadow-gray-100">
      <h1 className="text-3xl text-white font-semibold">Kategori Film</h1>
      <div className="flex gap-4 mt-8">
        {category.map((category) => (
          <div
            key={category.id}
            className="flex flex-col justify-center items-center rounded-sm bg-gray-700 w-20 h-20"
          >
